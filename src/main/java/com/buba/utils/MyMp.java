...
public class MyMp {
    ...
    private static String outputDir ="/Users/jia/idea/reception/src" +
            "/main/java";//生成的位置
    private static String driver ="com.mysql.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/data?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    private static String tablePrefix ="sec_";//数据库表的前缀，如tbl_user
    private static String [] tables = {"sec_forecast_data"};	//生成的表
